...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-p4zkccw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-p4zkccw.containers.anotherwebservice.com/
...
```
git clone git@github.com:avyas/container-p4zkccw.git
cd container-p4zkccw
```
...
```
docker attach container-p4zkccw
```
